...
Plans:
- [ ] 01-01-PLAN.md — Schema migration: SCHEMA_VERSION=7, ALTER TABLE tmdb_id/num_seasons, episode_progress table and DB methods
...
|-------|----------------|--------|-----------|
| 1. DB + API Foundation | 0/3 | Not started | - |
